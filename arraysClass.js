...
let arrLocal =
    [new Local(1, "Mapi", "25 de Mayo 259", 50, "./imagenes/Mapi.png", "Museo", [], "Diego", "Mapi123"),
    new Local(2, "H.Charrua", "Colon esq. Zabala", 100, "./imagenes/H.Charrua.jpg", "Museo", [], "Leandro", "HCharrua123"),
    ...
    new Local(6, "Solis", "Reaconquista y B. Mitre", 100, "./imagenes/Solis.jpg", "teatro", [], "Federico", "Solis123"),
    new Local(7, "Sodre", "Calle Andes esquina Mercedes", 200, "./imagenes/Sodre.jpg", "teatro", [], "Agustin", "Sodre123"),];

let arrUser = [
    //new User("Martin", "Martin", "Martin123");
    { id: 1, nombre: "Christian", userNombre: "Christian", password: "Christian123", type: "persona", reservas: [{id: 3, user: "Christian", local: "burger", cupos: 3, status: "finalizada", Image: "./imagenes/Burger.jpg"}]},
